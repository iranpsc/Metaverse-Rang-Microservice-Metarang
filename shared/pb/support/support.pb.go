...
type CreateReportRequest struct {
	...
	Reason         string                 `protobuf:"bytes,4,opt,name=reason,proto3" json:"reason,omitempty"`           // maps to Laravel title
	Description    string                 `protobuf:"bytes,5,opt,name=description,proto3" json:"description,omitempty"` // maps to Laravel content
	Url            string                 `protobuf:"bytes,6,opt,name=url,proto3" json:"url,omitempty"`
	ImageUrls      []string               `protobuf:"bytes,7,rep,name=image_urls,json=imageUrls,proto3" json:"image_urls,omitempty"` // stored as report images (public paths or full URLs)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ReportResponse struct {
	...
	AttachmentUrls []string               `protobuf:"bytes,9,rep,name=attachment_urls,json=attachmentUrls,proto3" json:"attachment_urls,omitempty"` // full public URLs for images
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReportResponse) GetAttachmentUrls() []string {
	if x != nil {
...
const file_support_proto_rawDesc = "" +
	...
	"\n" +
	"image_urls\x18\a \x03(\tR\timageUrls\"g\n" +
	...
	"\auser_id\x18\x02 \x01(\x04R\x06userId\"\x9b\x02\n" +
	...
	"\x0fattachment_urls\x18\t \x03(\tR\x0eattachmentUrls\"|\n" +
