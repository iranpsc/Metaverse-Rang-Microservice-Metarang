...
type VideoResponse struct {
	...
	UserInteraction *bool                  `protobuf:"varint,14,opt,name=user_interaction,json=userInteraction,proto3,oneof" json:"user_interaction,omitempty"` // true=liked, false=disliked; unset when guest or no interaction
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *VideoResponse) GetUserInteraction() bool {
	if x != nil && x.UserInteraction != nil {
...
type SubCategoryResponse struct {
	...
	IconUrl       string                 `protobuf:"bytes,8,opt,name=icon_url,json=iconUrl,proto3" json:"icon_url,omitempty"`
	Stats         *VideoStats            `protobuf:"bytes,9,opt,name=stats,proto3" json:"stats,omitempty"`
	Videos        []*VideoResponse       `protobuf:"bytes,10,rep,name=videos,proto3" json:"videos,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubCategoryResponse) GetVideos() []*VideoResponse {
	if x != nil {
		return x.Videos
	}
	return nil
...
type GetCommentsRequest struct {
	...
	VideoId       uint64                    `protobuf:"varint,1,opt,name=video_id,json=videoId,proto3" json:"video_id,omitempty"`
	Pagination    *common.PaginationRequest `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	UserId        uint64                    `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // optional: include per-comment user_interaction when authenticated
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CommentResponse struct {
	...
	UserInteraction *bool                  `protobuf:"varint,10,opt,name=user_interaction,json=userInteraction,proto3,oneof" json:"user_interaction,omitempty"` // true=liked, false=disliked; unset when guest or no interaction
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *CommentResponse) GetUserInteraction() bool {
	if x != nil && x.UserInteraction != nil {
		return *x.UserInteraction
	}
	return false
...
const file_training_proto_rawDesc = "" +
	...
	"\x10user_interaction\x18\x0e \x01(\bH\x00R\x0fuserInteraction\x88\x01\x01B\x13\n" +
	"\x11_user_interaction\"y\n" +
	...
	"\x0esub_categories\x18\x06 \x03(\v2\x19.training.SubCategoryInfoR\rsubCategories\x12\x1b\n" +
	"\timage_url\x18\a \x01(\tR\bimageUrl\x12\x19\n" +
	"\bicon_url\x18\b \x01(\tR\aiconUrl\x12*\n" +
	"\x05stats\x18\t \x01(\v2\x14.training.VideoStatsR\x05stats\"\x88\x01\n" +
	...
	"\fvideos_count\x18\x06 \x01(\x05R\vvideosCount\x12\x1b\n" +
	"\timage_url\x18\a \x01(\tR\bimageUrl\x12\x19\n" +
	"\bicon_url\x18\b \x01(\tR\aiconUrl\x12*\n" +
	"\x05stats\x18\t \x01(\v2\x14.training.VideoStatsR\x05stats\x12/\n" +
	"\x06videos\x18\n" +
	" \x03(\v2\x17.training.VideoResponseR\x06videos\"F\n" +
	"\fCategoryInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\"\xf2\x01\n" +
	"\x0fSubCategoryInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12!\n" +
	"\fvideos_count\x18\x05 \x01(\x05R\vvideosCount\x12\x1b\n" +
	"\timage_url\x18\x06 \x01(\tR\bimageUrl\x12\x19\n" +
	"\bicon_url\x18\a \x01(\tR\aiconUrl\x12*\n" +
	"\x05stats\x18\b \x01(\v2\x14.training.VideoStatsR\x05stats\"\x83\x01\n" +
	"\x12GetCommentsRequest\x12\x19\n" +
	"\bvideo_id\x18\x01 \x01(\x04R\avideoId\x129\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x19.common.PaginationRequestR\n" +
	"pagination\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\x04R\x06userId\"a\n" +
	...
	"\n" +
	"comment_id\x18\x01 \x01(\x04R\tcommentId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\"\xe4\x02\n" +
	...
	" \x01(\bH\x00R\x0fuserInteraction\x88\x01\x01B\x13\n" +
	"\x11_user_interaction\"\x81\x01\n" +
	...
	"\x13AddReplyInteraction\x12$.training.AddReplyInteractionRequest\x1a\r.common.EmptyB\x1dZ\x1bmetarang/shared/pb/trainingb\x06proto3"
...
var file_training_proto_depIdxs = []int32{
	...
	6,  // 11: training.CategoryResponse.stats:type_name -> training.VideoStats
	13, // 12: training.CategoriesResponse.categories:type_name -> training.CategoryResponse
	35, // 13: training.CategoriesResponse.pagination:type_name -> common.PaginationMeta
	16, // 14: training.SubCategoryResponse.category:type_name -> training.CategoryInfo
	6,  // 15: training.SubCategoryResponse.stats:type_name -> training.VideoStats
	4,  // 16: training.SubCategoryResponse.videos:type_name -> training.VideoResponse
	6,  // 17: training.SubCategoryInfo.stats:type_name -> training.VideoStats
	33, // 18: training.GetCommentsRequest.pagination:type_name -> common.PaginationRequest
	34, // 19: training.CommentResponse.user:type_name -> common.UserBasic
	24, // 20: training.CommentResponse.stats:type_name -> training.CommentStats
	22, // 21: training.CommentsResponse.comments:type_name -> training.CommentResponse
	35, // 22: training.CommentsResponse.pagination:type_name -> common.PaginationMeta
	33, // 23: training.GetRepliesRequest.pagination:type_name -> common.PaginationRequest
	22, // 24: training.RepliesResponse.replies:type_name -> training.CommentResponse
	35, // 25: training.RepliesResponse.pagination:type_name -> common.PaginationMeta
	0,  // 26: training.VideoService.GetVideos:input_type -> training.GetVideosRequest
	1,  // 27: training.VideoService.GetVideo:input_type -> training.GetVideoRequest
	2,  // 28: training.VideoService.GetVideoByFileName:input_type -> training.GetVideoByFileNameRequest
	3,  // 29: training.VideoService.SearchVideos:input_type -> training.SearchVideosRequest
	7,  // 30: training.VideoService.IncrementView:input_type -> training.IncrementViewRequest
	8,  // 31: training.VideoService.AddInteraction:input_type -> training.AddInteractionRequest
	9,  // 32: training.CategoryService.GetCategories:input_type -> training.GetCategoriesRequest
	10, // 33: training.CategoryService.GetCategory:input_type -> training.GetCategoryRequest
	11, // 34: training.CategoryService.GetSubCategory:input_type -> training.GetSubCategoryRequest
	12, // 35: training.CategoryService.GetCategoryVideos:input_type -> training.GetCategoryVideosRequest
	18, // 36: training.CommentService.GetComments:input_type -> training.GetCommentsRequest
	19, // 37: training.CommentService.AddComment:input_type -> training.AddCommentRequest
	20, // 38: training.CommentService.UpdateComment:input_type -> training.UpdateCommentRequest
	21, // 39: training.CommentService.DeleteComment:input_type -> training.DeleteCommentRequest
	25, // 40: training.CommentService.AddCommentInteraction:input_type -> training.AddCommentInteractionRequest
	26, // 41: training.CommentService.ReportComment:input_type -> training.ReportCommentRequest
	27, // 42: training.ReplyService.GetReplies:input_type -> training.GetRepliesRequest
	28, // 43: training.ReplyService.AddReply:input_type -> training.AddReplyRequest
	29, // 44: training.ReplyService.UpdateReply:input_type -> training.UpdateReplyRequest
	30, // 45: training.ReplyService.DeleteReply:input_type -> training.DeleteReplyRequest
	32, // 46: training.ReplyService.AddReplyInteraction:input_type -> training.AddReplyInteractionRequest
	...
	36, // 51: training.VideoService.IncrementView:output_type -> common.Empty
	36, // 52: training.VideoService.AddInteraction:output_type -> common.Empty
	14, // 53: training.CategoryService.GetCategories:output_type -> training.CategoriesResponse
	13, // 54: training.CategoryService.GetCategory:output_type -> training.CategoryResponse
	15, // 55: training.CategoryService.GetSubCategory:output_type -> training.SubCategoryResponse
	5,  // 56: training.CategoryService.GetCategoryVideos:output_type -> training.VideosResponse
	23, // 57: training.CommentService.GetComments:output_type -> training.CommentsResponse
	22, // 58: training.CommentService.AddComment:output_type -> training.CommentResponse
	22, // 59: training.CommentService.UpdateComment:output_type -> training.CommentResponse
	36, // 60: training.CommentService.DeleteComment:output_type -> common.Empty
	36, // 61: training.CommentService.AddCommentInteraction:output_type -> common.Empty
	36, // 62: training.CommentService.ReportComment:output_type -> common.Empty
	31, // 63: training.ReplyService.GetReplies:output_type -> training.RepliesResponse
	22, // 64: training.ReplyService.AddReply:output_type -> training.CommentResponse
	22, // 65: training.ReplyService.UpdateReply:output_type -> training.CommentResponse
	36, // 66: training.ReplyService.DeleteReply:output_type -> common.Empty
	36, // 67: training.ReplyService.AddReplyInteraction:output_type -> common.Empty
...
func file_training_proto_init() {
	...
	file_training_proto_msgTypes[4].OneofWrappers = []any{}
	file_training_proto_msgTypes[22].OneofWrappers = []any{}
	type x struct{}
