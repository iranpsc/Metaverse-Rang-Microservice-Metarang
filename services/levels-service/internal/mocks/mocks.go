...
type MockChallengeRepository struct {
	...
	IncrementViewsFunc              func(ctx context.Context, questionID uint64) error
	ValidateAnswerFunc              func(ctx context.Context, questionID, answerID uint64) (bool, error)
	HasUserAnsweredQuestionFunc     func(ctx context.Context, userID, questionID uint64) (bool, error)
	RecordUserAnswerFunc            func(ctx context.Context, userID, questionID, answerID uint64) error
	IncrementParticipantsFunc       func(ctx context.Context, questionID uint64) error
	CheckAnswerFunc                 func(ctx context.Context, answerID, questionID uint64) (bool, string, error)
	GetQuestionByIDFunc             func(ctx context.Context, questionID uint64) (*pb.Question, error)
	GetChallengeIntervalsFunc       func(ctx context.Context) (int32, int32, int32, error)
	GetUserAnswerCountsFunc         func(ctx context.Context, userID uint64) (int32, int32, error)
	GetTotalParticipantsFunc        func(ctx context.Context) (int32, error)
	GetVariableRateFunc             func(ctx context.Context, name string) (float64, error)
}

func (m *MockChallengeRepository) GetRandomUnansweredQuestion(ctx context.Context, userID uint64) (*pb.Question, error) {
	return m.GetRandomUnansweredQuestionFunc(ctx, userID)
}
func (m *MockChallengeRepository) IncrementViews(ctx context.Context, questionID uint64) error {
	return m.IncrementViewsFunc(ctx, questionID)
}
func (m *MockChallengeRepository) ValidateAnswer(ctx context.Context, questionID, answerID uint64) (bool, error) {
	return m.ValidateAnswerFunc(ctx, questionID, answerID)
}
func (m *MockChallengeRepository) HasUserAnsweredQuestion(ctx context.Context, userID, questionID uint64) (bool, error) {
	return m.HasUserAnsweredQuestionFunc(ctx, userID, questionID)
}
func (m *MockChallengeRepository) RecordUserAnswer(ctx context.Context, userID, questionID, answerID uint64) error {
	return m.RecordUserAnswerFunc(ctx, userID, questionID, answerID)
}
func (m *MockChallengeRepository) IncrementParticipants(ctx context.Context, questionID uint64) error {
	return m.IncrementParticipantsFunc(ctx, questionID)
}
func (m *MockChallengeRepository) CheckAnswer(ctx context.Context, answerID, questionID uint64) (bool, string, error) {
	return m.CheckAnswerFunc(ctx, answerID, questionID)
}
func (m *MockChallengeRepository) GetQuestionByID(ctx context.Context, questionID uint64) (*pb.Question, error) {
	return m.GetQuestionByIDFunc(ctx, questionID)
}
func (m *MockChallengeRepository) GetChallengeIntervals(ctx context.Context) (int32, int32, int32, error) {
	return m.GetChallengeIntervalsFunc(ctx)
}
func (m *MockChallengeRepository) GetUserAnswerCounts(ctx context.Context, userID uint64) (int32, int32, error) {
	return m.GetUserAnswerCountsFunc(ctx, userID)
}
func (m *MockChallengeRepository) GetTotalParticipants(ctx context.Context) (int32, error) {
	return m.GetTotalParticipantsFunc(ctx)
}
func (m *MockChallengeRepository) GetVariableRate(ctx context.Context, name string) (float64, error) {
	return m.GetVariableRateFunc(ctx, name)
}
