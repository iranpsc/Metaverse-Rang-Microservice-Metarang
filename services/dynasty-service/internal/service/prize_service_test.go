...
func TestPrizeService_GetUserReceivedPrizes(t *testing.T) {
	...
	svc := NewPrizeService(db, prizeRepo, nil, nil, nil)
...
func TestPrizeService_ClaimPrize(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		svc := NewPrizeService(db, prizeRepo, varRepo, userVarRepo, wallet)
	...
	t.Run("Unauthorized", func(t *testing.T) {
		...
		svc := NewPrizeService(db, repository.NewPrizeRepository(db), repository.NewVariableRepository(db), repository.NewUserVariableRepository(db), &stubWallet{})
	...
	t.Run("WalletNotConfigured", func(t *testing.T) {
		...
		svc := NewPrizeService(db, repository.NewPrizeRepository(db), repository.NewVariableRepository(db), repository.NewUserVariableRepository(db), nil)
...
func TestPrizeService_ClaimPrize_WalletErrorBeforeTx(t *testing.T) {
	...
	svc := NewPrizeService(db, repository.NewPrizeRepository(db), repository.NewVariableRepository(db), repository.NewUserVariableRepository(db), &stubWallet{pscErr: errors.New("commercial down")})
