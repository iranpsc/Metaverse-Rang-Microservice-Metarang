...
func TestGetEvents_DefaultPagination(t *testing.T) {
	...
	m.GetEventsFunc = func(ctx context.Context, eventType, search, date string, userID uint64, page, perPage int32) ([]*models.Calendar, int32, error) {
		return []*models.Calendar{{ID: 1, Title: "A", Content: "c", StartsAt: time.Now(), Color: "#fff"}}, 1, nil
	}
...
func TestGetEvents_WithDateNoPagination(t *testing.T) {
	m := &testutil.MockCalendarRepo{}
	m.GetEventsFunc = func(ctx context.Context, eventType, search, date string, userID uint64, page, perPage int32) ([]*models.Calendar, int32, error) {
		return []*models.Calendar{{ID: 1, Title: "A", Content: "c", StartsAt: time.Now(), Color: "#fff"}}, 3, nil
	}
	m.GetEventStatsFunc = func(ctx context.Context, eventID uint64) (*models.CalendarStats, error) {
		return &models.CalendarStats{}, nil
	}
