...
func TestMarketplaceService_CreateSellRequest(t *testing.T) {
	...
	t.Run("success with explicit prices", func(t *testing.T) {
		...
		// Note: MarketplaceService has unexported fields, need to use constructor or skip
		t.Skip("Test requires MarketplaceService to be refactored to use interfaces or export fields")
